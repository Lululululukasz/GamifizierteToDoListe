...
CategoryViewPage::CategoryViewPage(todolib::Profile &profile) : MainPage{profile} {
    ...
    optional<QString> CategoryViewPage::getCategoryName() {
        ...
        bool ok;
        QString categoryNameInput = categoryNameInputDialog->getText(this, "New Category", "enter the category name",
    ...
    void CategoryViewPage::addCategoryWidget(Category &category) {
        ...
        connect(widget.get(), &CategoryWidget::categoryDeleteSignal, this,
                [=, this]() { openConfirmDeleteWindow(widget); });
    ...
    void CategoryViewPage::openConfirmDeleteWindow(std::shared_ptr<CategoryWidget> categoryWidget) {
        ...
        connect(confirmDeleteWindow.get(), &ConfirmDeleteWindow::confirmDelete, this,
                [=, this]() { deleteCategory(categoryWidget); });
    }